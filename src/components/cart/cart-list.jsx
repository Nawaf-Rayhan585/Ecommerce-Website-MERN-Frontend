                                        ...
                                        CartList.map((item,i)=>{
                                            ...
                                            return(<li className="list-group-item d-flex justify-content-between align-items-start">
                                                    ...
                                                    <div className="ms-2 me-auto">
                                                        <p className="fw m-0">{item['product']['title']}</p>
                                                        <p className="fw my-1">Unit Price: {price},Qty: {item['qty']}, Size: {item['size']}, Color: {item['color']}</p>
                                                        <p className=" h6 fw-bold m-0 text-danger">Total <i className="bi bi-currency-dollar"></i>{parseInt(price)*parseInt(item['qty'])}</p>
                                                    </div>
