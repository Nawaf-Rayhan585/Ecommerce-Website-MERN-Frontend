...
import NotInStock from "../../skeleton/not-in-stock";
            ...
            <div className="row">
                <div className="col-md-3 p-2">
                    <div className="card vh-100 p-3 shadow-sm">
                        ...
                        <input value={Filter.priceMax} onChange={async (e)=>{await inputOnChange('priceMax',e.target.value)}} min={0} max={100000} step={100} type="range" className="form-range" />


                        <label className="form-label mt-3">Minimum Price ${Filter.priceMin}</label>
                        <input value={Filter.priceMin} onChange={async (e)=>{await inputOnChange('priceMin',e.target.value)}} min={0} max={100000} step={100} type="range" className="form-range" />
                    </div>
                </div>
